...
class Handover(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            'rule_risk_score': self.risk_assessment.risk_score if self.risk_assessment else None,
            'rule_risk_level': self.risk_assessment.risk_level if self.risk_assessment else None,
            'ai_risk_score': self.risk_score,
